            ...
            <div className="space-y-6">
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">info@agromart.com</p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">123 Farming Road, Agriculture District</p>
                  <p className="text-gray-600">India - 123456</p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">Monday - Friday: 9 AM - 6 PM</p>
